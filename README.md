...
![Изображение](/photoo/15.png/)



# Конфликт слияния веток

* В коммите "main" вводим рандомный текст
* В коммите "veter22" другой рандомный текст
* Создаем в обоих ветках разные коммиты
* С помощью комманды ```git merge``` производим сливание веток

![Изображение](/photoo/16.png/)


* Наблюдаем Конфликт

![Изображение](/photoo/17.png/)
